...
export class UsersService {
  ...
  login(obj) {
    return this.http.post<any>(`${environment.url}/api/users/token.json`, obj)
      .pipe(
        tap(
          res => 

          this.generic.showNotification('success', this.lang.loginTitleTxt ,this.lang.loginSuccessTxt),
